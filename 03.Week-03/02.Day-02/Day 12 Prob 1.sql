...
(1,'Tech Conference','Technology','2026-06-10','Technology Event','Active');

--Insert Speaker

INSERT INTO SessionInfo VALUES
(1001,1,'AI Trends',101,'Discussion on AI',
'2026-06-10 10:00:00',
'2026-06-10 11:00:00',
...
(1,'john@mail.com',1,1001,1);

--View All Events
SELECT * FROM EventDetails;

--View Sessions with Speaker Names
SELECT 
SessionTitle,
SpeakerName,
SessionStart,
SessionEnd
FROM SessionInfo
JOIN SpeakersDetails
ON SessionInfo.SpeakerId = SpeakersDetails.SpeakerId;
...
JOIN UserInfo
ON ParticipantEventDetails.ParticipantEmailId = UserInfo.EmailId
JOIN EventDetails
ON ParticipantEventDetails.EventId = EventDetails.EventId
JOIN SessionInfo
ON ParticipantEventDetails.SessionId = SessionInfo.SessionId;
